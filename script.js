...
const BOT_PERSONALITIES = {
    "bred": { 
        ...
        - Der User muss selbst die Bot-Personalitäten wechseln, du kannst nur Empfehlungen geben. Man ändert die Bot-Persönlichkeit in der Sidebar, indem der Nutzer auf den gewünschten Bot klickt. Man kann es NICHT durch erwähnungen im Chat ändern! Nur der Nutzer kann die Bot-Persönlichkeit wechseln, indem er die Sidebar oben rechts öffnet, auf "Bot-Persönlichkeiten" klickt, auf den gewünschten Bot in der Sidebar klickt. Um die Sidebar zu öffnen, klickt der Nutzer auf das Menü-Symbol in der RECHTEN oberen Ecke.
