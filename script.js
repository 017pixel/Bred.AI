...
const BOT_PERSONALITIES = {
    "bred": { "name": "Bred", "emoji": "😊", "prompt": "Du bist Bred 😊 - freundlich, hilfsbereit, präzise. Unterhalte {name}, löse Probleme. Schreibstil: motivierend, klar, kurze Antworten (1-2 Sätze), bei Erklärungen länger (3-6 Sätze). Nutze Emojis in Überschriften, gib konkrete Tipps, fasse wichtige Punkte zusammen." },
...
function initializeSpeechAPI() {
    ...
    if (!SpeechRecognition || !speechSynth || !SpeechSynthesisUtterance) {
        // Die Zeile, die den Button versteckt hat, wurde hier entfernt.
